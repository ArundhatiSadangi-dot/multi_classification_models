...
The repository caches the dataset to `data/breast_cancer_wisconsin.csv` when `train_models.py` is run.
...
- `figs/*_cm.png` — confusion matrix images
...
│  └─ figs/*_cm.png
└─ data/
   └─ breast_cancer_wisconsin.csv  # cached dataset
```
